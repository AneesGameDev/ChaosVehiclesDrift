...
USTRUCT()
	struct WHEELEDVEHICLES_API FVehicleAnimationInstanceProxy : public FAnimInstanceProxy
{
	GENERATED_BODY()
...
UCLASS(transient)
	class WHEELEDVEHICLES_API UVehicleAnimationInstance : public UAnimInstance
{
