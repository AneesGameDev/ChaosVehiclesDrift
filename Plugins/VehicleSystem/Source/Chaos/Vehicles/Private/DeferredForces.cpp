...
void FDeferredForces::ApplyInstantTorque(Chaos::FRigidBodyHandle_Internal* RigidHandle,
	const FAddTorqueInRadiansData& DataIn) {
	AddTorque(RigidHandle,DataIn);
}

void FDeferredForces::ApplyInstantForce(Chaos::FRigidBodyHandle_Internal* RigidHandle, const FApplyForceData& DataIn) {
	AddForce(RigidHandle,DataIn);
}
