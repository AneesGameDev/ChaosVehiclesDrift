...
class VEHICLES_API FDeferredForces
{
public:
	...
	void ApplyInstantTorque(Chaos::FRigidBodyHandle_Internal* RigidHandle, const FAddTorqueInRadiansData& DataIn);
	void ApplyInstantForce(Chaos::FRigidBodyHandle_Internal* RigidHandle, const FApplyForceData& DataIn);
private:
