 ...
 */
class IVehiclesEditorModule : public IModuleInterface
{
...
public:
	 ...
	 */
	static inline IVehiclesEditorModule& Get()
	{
		return FModuleManager::LoadModuleChecked< IVehiclesEditorModule >( "VehiclesEditor" );
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded( "VehiclesEditor" );
	}
