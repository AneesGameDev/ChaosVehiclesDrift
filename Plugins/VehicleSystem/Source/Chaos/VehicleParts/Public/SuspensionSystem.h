...
namespace Chaos
{
	...
	struct VEHICLEPARTS_API FSimpleSuspensionConfig
	{
	...
	struct VEHICLEPARTS_API FSuspensionTrace
	{
		FVector Start;
		FVector End;
	...
	class VEHICLEPARTS_API FSimpleSuspensionSim : public TVehicleSystem<FSimpleSuspensionConfig>
	{
	public:
