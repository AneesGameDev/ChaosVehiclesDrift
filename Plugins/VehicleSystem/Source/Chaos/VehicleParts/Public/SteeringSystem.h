...
namespace Chaos
{
	...
	struct VEHICLEPARTS_API FSimpleSteeringConfig
	{
	...
	class VEHICLEPARTS_API FAckermannSim : public TVehicleSystem<FSimpleSteeringConfig>
	{
	public:
	...
	class VEHICLEPARTS_API FSimpleSteeringSim : public TVehicleSystem<FSimpleSteeringConfig>
	{
	public:
