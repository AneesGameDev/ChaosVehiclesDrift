...
namespace Chaos
{
	...
	struct VEHICLEPARTS_API FAerofoilSettings
	{
		FAerofoilSettings()
	...
	class VEHICLEPARTS_API FAerofoilSimModule : public ISimulationModuleBase, public TSimModuleSettings<FAerofoilSettings>
	{
	public:
