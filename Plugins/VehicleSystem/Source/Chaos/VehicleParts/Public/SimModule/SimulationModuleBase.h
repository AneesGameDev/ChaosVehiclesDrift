...
struct VEHICLEPARTS_API FCoreModularVehicleDebugParams
{
	bool ShowMass = false;
...
namespace Chaos
{
	...
	struct VEHICLEPARTS_API FControlInputs
	{
	...
	struct VEHICLEPARTS_API FModuleHitResults
	{
		int SimIndex;
		FVector ImpactPoint;
		float Distance;
	...
	struct VEHICLEPARTS_API FAllInputs : public FControlInputs
	{
	 ...
	 */
	template <typename T>
	class VEHICLEPARTS_API TSimModuleSettings
	{
	public:
	 ...
	 */
	class VEHICLEPARTS_API ISimulationModuleBase
	{
	public:
