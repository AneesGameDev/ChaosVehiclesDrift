...
namespace Chaos
{
	...
	struct VEHICLEPARTS_API FTransmissionSettings
	{
	...
	class VEHICLEPARTS_API FTransmissionSimModule : public FTorqueSimModule, public TSimModuleSettings<FTransmissionSettings>
	{
	public:
