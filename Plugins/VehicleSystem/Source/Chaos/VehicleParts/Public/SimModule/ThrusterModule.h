...
namespace Chaos
{
	...
	/// Thruster settings
	/// </summary>
	struct VEHICLEPARTS_API FThrusterSettings
	{
		FThrusterSettings()
			: MaxThrustForce(0)
	...
	///
	/// </summary>
	class VEHICLEPARTS_API FThrusterSimModule : public ISimulationModuleBase, public TSimModuleSettings<FThrusterSettings>
	{
	public:
