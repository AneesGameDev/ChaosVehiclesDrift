...
namespace Chaos
{
	...
	struct VEHICLEPARTS_API FSuspensionSettings
	{
		FSuspensionSettings()
	...
	struct VEHICLEPARTS_API FSpringTrace
	{
		FVector Start;
		FVector End;
	...
	class VEHICLEPARTS_API FSuspensionSimModule : public ISimulationModuleBase, public TSimModuleSettings<FSuspensionSettings>
	{
	public:
