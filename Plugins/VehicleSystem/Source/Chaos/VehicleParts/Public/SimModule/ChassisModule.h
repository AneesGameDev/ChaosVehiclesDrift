...
namespace Chaos
{
	...
	/// Chassis settings
	/// </summary>
	struct VEHICLEPARTS_API FChassisSettings
	{
		FChassisSettings()
		{
	...
	///
	/// </summary>
	class VEHICLEPARTS_API FChassisSimModule : public ISimulationModuleBase, public TSimModuleSettings<FChassisSettings>
	{
	public:
