...
namespace Chaos
{
	...
	struct VEHICLEPARTS_API FSimpleThrustConfig
	{
		EThrustType Type;
		FVector Offset;
		FVector Axis;
	...
	class VEHICLEPARTS_API FSimpleThrustSim : public TVehicleSystem<FSimpleThrustConfig>
	{
	public:
		...
		// simulate
		void Simulate(const struct FControlInputs ControlInputs, const struct FVehicleState& VehicleState, const FRigidBodyHandle_Internal * RigidHandle, float DeltaTime);
