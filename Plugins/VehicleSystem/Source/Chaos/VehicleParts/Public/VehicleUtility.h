...
namespace Chaos
{
	...
	struct VEHICLEPARTS_API RealWorldConsts
	{
	...
	class VEHICLEPARTS_API FNormalisedGraph
	{
	public:
		void Empty()
		{
	...
	class VEHICLEPARTS_API FVehicleUtility
	{
	public:
	...
	class VEHICLEPARTS_API FTimeAndDistanceMeasure
	{
	public:
	...
	class VEHICLEPARTS_API FPerformanceMeasure
	{
	public:
