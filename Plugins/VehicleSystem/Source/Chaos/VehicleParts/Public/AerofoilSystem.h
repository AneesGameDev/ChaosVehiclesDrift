...
namespace Chaos
{
	...
	struct VEHICLEPARTS_API FAerofoilConfig
	{
		FAerofoilConfig()
	...
	class VEHICLEPARTS_API FAerofoil : public TVehicleSystem<FAerofoilConfig>
	{
	public:
		FAerofoil()
		{}

		void Simulate(const FControlInputs& ControlInput);
