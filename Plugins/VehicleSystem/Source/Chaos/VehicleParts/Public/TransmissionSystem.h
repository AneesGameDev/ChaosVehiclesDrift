...
namespace Chaos
{
	...
	struct VEHICLEPARTS_API FSimpleDifferentialConfig
	{
	...
	class VEHICLEPARTS_API FSimpleDifferentialSim : public TVehicleSystem<FSimpleDifferentialConfig>
	{
	public:
	...
	struct VEHICLEPARTS_API FSimpleTransmissionConfig
	{
	...
	class VEHICLEPARTS_API FSimpleTransmissionSim : public TVehicleSystem<FSimpleTransmissionConfig>
	{
	public:
